---
name: creating-pr
description: Creates review-ready pull requests with structured summaries and test plans using gh. Use when the user asks to create a PR, open a pull request, or package work for review.
---
